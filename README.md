...
|---|---|---|---|
| **Climate Schedule** | `2026.8.1` | Applies a climate preset at a scheduled time. Use one automation per preset, so day and night can be turned on and off separately. | [![Open your Home Assistant instance and show the blueprint import dialog.](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2Fnofuturekid%2Fha-blueprints%2Fblob%2Fmain%2Fblueprints%2Fautomation%2Fclimate_schedule.yaml) |
